            ...
            <div className="w-full mb-[30px] ">
                ...
                <div className="w-full">
                    ...
                    {detailAuthor?.attributes?.paint?.data.attributes?.url ?
                                <Image src={process.env.NEXT_PUBLIC_STRAPI_API_URL + (author?.attributes?.paint?.data.attributes?.url ?? '' )} className='w-full h-[462px] bg-zinc-700' width={1920} height={462}/>
                                :
